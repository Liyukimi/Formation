...
@Controller
@RequestMapping(PageFolderMapping.EMPLOYES_PATH)
public class EmployesController {

	private static final String EMPLOYES_PATH = PageFolderMapping.EMPLOYES_PATH;
	...
	protected String listeEmployes(Model model) {
		...
		return EMPLOYES_PATH+"listeEmployes";
	}
	...
	protected ModelAndView detailEmploye(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return new ModelAndView(EMPLOYES_PATH+"detailEmploye", "employe", employe);
	}
